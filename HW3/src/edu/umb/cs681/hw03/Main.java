	...
	public static void main(String[] args) throws Exception {
        ...
        var neighbouringCounties = Files.readAllLines(path)
                ...
                .filter(line -> line.contains("Massachusetts, Barnstable")
                        || line.contains("Massachusetts, Hampshire")
        ...
        System.out.print("Average PVI of  neighbouring counties and our county is: ");
        ...
        var avInfectionRate = neighbouringCounties.stream()
                ...
                .reduce(new double[2], (result, pvi) -> {
                        ...
                        (finalResult, intermediateResult) -> finalResult)[1];
        System.out.print("Average infection rate of  neighbouring counties and our county is: ");
        ...
        var avVaxRate = neighbouringCounties.stream()
                ...
                .reduce(new double[2], (result, pvi) -> {
                        ...
                        (finalResult, intermediateResult) -> finalResult)[1];
        System.out.print("Average vaccination rate of  neighbouring counties and our county is: ");
        ...
        System.out.println("Mean of Mass State counties: " + meanPVI);
        System.out.print("Standard Deviation of Mass State counties: ");
